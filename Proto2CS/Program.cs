...
namespace Proto2CS
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            Proto2CS("Server", "OuterMessage.proto", clientMessagePath, "OuterOpcode", 100);

            Proto2CS("Hotfix", "HotfixMessage.proto", hotfixMessagePath, "HotfixOpcode", 10000);
    ...
    public static class InnerProto2CS
    {
        ...
        {
            msgOpcode.Clear();
            Proto2CS("Server", "InnerMessage.proto", serverMessagePath, "InnerOpcode", 1000);
            GenerateOpcode("Server", "InnerOpcode", serverMessagePath);
        }
